...
#calculate predictive margins for factor variables
margin_build.factor <- function(object, newdata = NULL, term, value = NULL, se = TRUE,se.method = "delta", CI = TRUE, CI.boots = FALSE, level = 0.95,eps = 1e-7,na.action = na.pass,iter = 50){
  ...
  for(i in value){
    ...
    data_premarg[,term] = factor(i,levels = levs)
